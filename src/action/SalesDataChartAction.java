...
public class SalesDataChartAction extends ActionSupport {  
    ...
    public JFreeChart getChart() {
        ...
        chart = ChartFactory.createBarChart3D("销项发票数据统计分析图", "月份",  
    ...
    private CategoryDataset getDataSet() {  
        ...
        //}
        data.setValue(4.5, "1月", "1月");
        data.setValue(4.9, "2月", "2月");
        data.setValue(5.1, "3月", "3月");
        data.setValue(6.3, "4月", "4月");
        data.setValue(6.4, "5月", "5月");
        data.setValue(5.2, "6月", "6月");
        data.setValue(5.6, "7月", "7月");
        data.setValue(6.5, "8月", "8月");
        data.setValue(6.3, "9月", "9月");
        data.setValue(7.2, "10月", "10月");
        data.setValue(6.6, "11月", "11月");
        data.setValue(7.4, "12月", "12月");
        return data;  
    }
}